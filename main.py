...
def update_stonks(room_id, json):
    ...
    print('update_stocks')
    lis = {"название акции": {'quantity': 'количество числом',
                              'price': 'цена числом',
                              'cost': 'стоимость числом'},
           "название акции2": {'quantity': 'количество числом',
                               'cost': 'цена числом'},
           "название акции3": {'quantity': 'количество числом',
                               'cost': 'цена числом'}
           }
